                                    ...
                                    <div className="flex flex-col sm:flex-row gap-6 sm:gap-8 items-start">
                                        ...
                                        <div className="relative mb-6 sm:mb-0 w-14 h-14 shrink-0">
                                            ...
                                            >
                                                ...
                                                {/* Icon */}
                                                <feature.icon className="w-6 h-6 relative z-10 transform transition-transform duration-700 group-hover:scale-110 group-data-[hovering=true]:scale-110" style={{ color: feature.color }} strokeWidth={1.8} />
                                            </div>
                                        </div>
                                        ...
                                        <div className="min-w-0 flex-1">
                                            ...
                                            <h3 className="text-xl sm:text-2xl font-bold text-white mb-3 tracking-tight leading-snug transition-all duration-500 group-hover:translate-x-1 group-data-[hovering=true]:translate-x-1"
                                                style={{ textShadow: `0 0 40px ${feature.color}00` }}>
                                                {feature.title}
                                            </h3>

                                            <p className="text-[15px] sm:text-base text-[#8A8A93] leading-relaxed transition-all duration-500 group-hover:text-[#A0A0A5] group-data-[hovering=true]:text-[#A0A0A5] group-hover:translate-x-1 group-data-[hovering=true]:translate-x-1">
                                                {feature.desc}
                                            </p>
                                        </div>
                                    </div>
